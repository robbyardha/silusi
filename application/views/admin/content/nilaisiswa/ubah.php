                                ...
                                <div class="p-2">
                                    <form action="" method="POST">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <?php
                                                // var_dump($nilai_siswa['id']);
                                                // die;
                                                // 
                                                ?>
                                                <input type="hidden" class="form-control col-5" name="id" value="<?= $nilai_siswa['id'] ?>">
                                                <select class="form-control" id="nama_siswa" name="nama_siswa">
                                                    <?php foreach ($siswa as $s) : ?>
                                                        <option value="<?= $s['id'] ?>" <?php if ($s['id'] == $nilai_siswa['siswa_id']) {
                                                                                            echo "selected";
                                                                                        } ?>><?= " (" .  $s['nis'] . ")" . " " . $s['nama'] ?></option>
                                                    <?php endforeach ?>
                                                    <br>
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" id="mapel" name="mapel">
                                                    <?php foreach ($mapel as $m) : ?>
                                                        <option value="<?= $m['id'] ?>" <?php if ($m['id'] == $nilai_siswa['mapel_id']) {
                                                                                            echo "selected";
                                                                                        } ?>><?= $m['nama_mapel'] ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" id="status_lulus" name="status_lulus">
                                                    <?php if ($nilai_siswa['status_lulus'] == "Lulus") : ?>
                                                        <option value="Lulus" selected>Lulus</option>
                                                        <option value="Tidak Lulus">Tidak Lulus</option>
                                                    <?php elseif ($nilai_siswa['status_lulus'] == "Tidak Lulus") : ?>
