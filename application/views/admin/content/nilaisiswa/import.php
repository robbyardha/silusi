    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="header-title">Import Data Nilai Siswa</h4>
                        <!-- <p class="sub-header">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="<?= base_url('admin/nilai_ujian/downloadFormat') ?>" class="btn btn-primary">Download Data</a>
                                <div class="p-2">
                                    <?php echo form_open_multipart('admin/nilai_ujian/import', array('name' => 'spreadsheet')); ?>
                                    <br>
