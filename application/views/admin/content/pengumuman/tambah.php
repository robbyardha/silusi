    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="header-title">Tambah Data Pengumuman</h4>
                        <!-- <p class="sub-header">
                                ...
                                <div class="p-2">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" rows="5" name="pengumuman" id="pengumuman"></textarea>
                                                <br>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" readonly name="created_by" id="created_by" class="form-control" value="<?= $this->session->userdata('nama') ?>">
                                                <br>
